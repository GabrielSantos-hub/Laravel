        ...
        <div class="card-body p-4">
            ...
            <form action="{{ route('frameworks.store') }}" method="POST">
                ...
                <div class="d-flex gap-2 mt-4">
                    <button type="submit" class="btn focus:ring-2 focus:ring-indigo-500 focus:outline-none text-white px-4" style="background-color: #5b4ce6; border-radius: 6px; font-weight: 500;">
                        Salvar Framework
                    </button>
                    <a href="{{ route('frameworks.index') }}" class="btn focus:ring-2 focus:ring-indigo-500 focus:outline-none btn-light border px-4" style="border-radius: 6px; font-weight: 500;">
                        Cancelar
                    </a>
                </div>
            </form>
