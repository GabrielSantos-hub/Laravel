                ...
                <tbody>
                    ...
                    <tr>
                        ...
                        <td class="px-4 py-3 text-end">
                            <a href="{{ route('languages.edit', $lang->id) }}" class="btn btn-dark btn-sm me-2 px-3">Editar</a>

                            <form action="{{ route('languages.destroy', $lang->id) }}" method="POST" class="d-inline">
                                @csrf
                                @method('DELETE')
