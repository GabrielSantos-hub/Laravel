            ...
            @auth
                ...
                @else
                    <div class="d-flex flex-wrap gap-2 mt-auto">
                        <a href="{{ route('home', array_merge(request()->query(), ['language_id' => $lang->id])) }}" class="btn-catalog btn-catalog-secondary focus:ring-2 focus:ring-indigo-500 focus:outline-none">Selecionar</a>
                    </div>
                @endif
            @endauth
        </article>
